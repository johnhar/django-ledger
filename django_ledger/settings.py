...
DJANGO_LEDGER_ENABLE_NONPROFIT_FEATURES = getattr(settings, 'DJANGO_LEDGER_ENABLE_NONPROFIT_FEATURES', False)
...
DJANGO_LEDGER_JE_NUMBER_NO_FUND_PREFIX = getattr(settings, 'DJANGO_LEDGER_JE_NUMBER_NO_FUND_PREFIX', '000') \
    if DJANGO_LEDGER_ENABLE_NONPROFIT_FEATURES else ''
DJANGO_LEDGER_FUND_TRANSFER_NUMBER_PREFIX = getattr(settings, 'DJANGO_LEDGER_FUND_TRANSFER_NUMBER_PREFIX', 'FT') \
    if DJANGO_LEDGER_ENABLE_NONPROFIT_FEATURES else ''
